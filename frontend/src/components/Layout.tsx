...
import { clearTransactionImportDraft, scanPendingTransactionImports } from '../utils/transactionImportStorage';
...
export default function Layout() {
    ...
    const logout = () => {
        ...
        if (Number.isSafeInteger(userId) && userId > 0 && scanPendingTransactionImports(localStorage, userId).length) {
