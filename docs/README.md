...
See [ADR-010](ADR/ADR-010-legacy-opening-position-migration.md) and the [Phase 2B-3 closing review](review/V3.0-Phase2B-3-Closing-Review.md) for the explicit Legacy opening migration boundary.
