...
> 覆盖至 `v3.0 Phase 2C-3 Investment Read Frontend`；Phase 2C Investment Read 已整体关闭并获得 GO。
...
投资读取模型契约与各层实现分别由 [Phase 2C-1 design](design/V3.0-Phase2C-1-Investment-Read-Model-Contract.md)、[ADR-015](ADR/ADR-015-investment-read-model-contract.md)、[Phase 2C-2A Review](review/V3.0-Phase2C-2A-Closing-Review.md)、[Phase 2C-2B Review](review/V3.0-Phase2C-2B-Closing-Review.md)、[Phase 2C-2C Review](review/V3.0-Phase2C-2C-Closing-Review.md) 与 [Phase 2C-3 Review](review/V3.0-Phase2C-3-Closing-Review.md) 冻结并验收。
